...
import com.iamsee.toolbean.daochu;
import com.iamsee.valuebean.baseinfo;

public class todownservlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public todownservlet() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		ArrayList<baseinfo> downlist = (ArrayList<baseinfo>) session.getAttribute("downlist");
